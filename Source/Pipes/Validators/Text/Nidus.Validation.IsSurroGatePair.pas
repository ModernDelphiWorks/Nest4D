...
unit Nidus.Validation.IsSurroGatePair;
...
type
  TIssurrogatepair = class(TValidatorConstraint)
  public
...
function TIssurrogatepair.Validate(const Value: TValue;
