...
unit Nidus.Validation.IsNumberString;
...
type
  TIsnumberstring = class(TValidatorConstraint)
  public
...
function TIsnumberstring.Validate(const Value: TValue;
