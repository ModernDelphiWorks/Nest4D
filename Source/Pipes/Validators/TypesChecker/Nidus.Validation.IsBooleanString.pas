...
unit Nidus.Validation.IsBooleanString;
...
type
  TIsbooleanstring = class(TValidatorConstraint)
  public
...
function TIsbooleanstring.Validate(const Value: TValue;
