...
unit Nidus.Validation.IsNotEmptyObject;
...
type
  TIsnotemptyobject = class(TValidatorConstraint)
  public
...
function TIsnotemptyobject.Validate(const Value: TValue;
