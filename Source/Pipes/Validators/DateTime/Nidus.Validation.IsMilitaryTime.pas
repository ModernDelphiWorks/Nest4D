...
unit Nidus.Validation.IsMilitaryTime;
...
type
  TIsmilitarytime = class(TValidatorConstraint)
  public
...
function TIsmilitarytime.Validate(const Value: TValue;
