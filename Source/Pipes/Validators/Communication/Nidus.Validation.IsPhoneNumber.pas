...
unit Nidus.Validation.IsPhoneNumber;
...
type
  TIsphonenumber = class(TValidatorConstraint)
  public
...
function TIsphonenumber.Validate(const Value: TValue;
