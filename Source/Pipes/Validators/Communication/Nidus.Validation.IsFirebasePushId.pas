...
unit Nidus.Validation.IsFirebasePushId;
...
type
  TIsfirebasepushid = class(TValidatorConstraint)
  public
...
function TIsfirebasepushid.Validate(const Value: TValue;
