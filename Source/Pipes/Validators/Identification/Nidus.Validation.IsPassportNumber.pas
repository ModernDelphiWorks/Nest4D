...
unit Nidus.Validation.IsPassportNumber;
...
type
  TIspassportnumber = class(TValidatorConstraint)
  public
...
function TIspassportnumber.Validate(const Value: TValue;
