...
unit Nidus.Validation.IsIdentityCard;
...
type
  TIsidentitycard = class(TValidatorConstraint)
  public
...
function TIsidentitycard.Validate(const Value: TValue;
