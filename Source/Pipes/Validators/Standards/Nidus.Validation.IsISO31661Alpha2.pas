...
unit Nidus.Validation.IsISO31661Alpha2;
...
type
  TIsiso31661alpha2 = class(TValidatorConstraint)
  public
...
function TIsiso31661alpha2.Validate(const Value: TValue;
