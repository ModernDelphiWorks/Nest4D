...
unit Nidus.Validation.IsISO31661Alpha3;
...
type
  TIsiso31661alpha3 = class(TValidatorConstraint)
  public
...
function TIsiso31661alpha3.Validate(const Value: TValue;
