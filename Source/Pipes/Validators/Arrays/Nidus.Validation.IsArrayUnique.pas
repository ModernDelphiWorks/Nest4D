...
unit Nidus.Validation.IsArrayUnique;
...
type
  TIsarrayunique = class(TValidatorConstraint)
  public
...
function TIsarrayunique.Validate(const Value: TValue;
