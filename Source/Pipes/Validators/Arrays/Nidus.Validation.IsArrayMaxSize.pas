...
unit Nidus.Validation.IsArrayMaxSize;
...
type
  TIsarraymaxsize = class(TValidatorConstraint)
  public
...
function TIsarraymaxsize.Validate(const Value: TValue;
