...
unit Nidus.Validation.IsArrayMinSize;
...
type
  TIsarrayminsize = class(TValidatorConstraint)
  public
...
function TIsarrayminsize.Validate(const Value: TValue;
