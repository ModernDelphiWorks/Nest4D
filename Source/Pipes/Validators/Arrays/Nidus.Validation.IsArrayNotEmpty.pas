...
unit Nidus.Validation.IsArrayNotEmpty;
...
type
  TIsarraynotempty = class(TValidatorConstraint)
  public
...
function TIsarraynotempty.Validate(const Value: TValue;
