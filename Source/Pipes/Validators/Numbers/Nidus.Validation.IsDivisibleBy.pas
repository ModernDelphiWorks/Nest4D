...
unit Nidus.Validation.IsDivisibleBy;
...
type
  TIsdivisibleby = class(TValidatorConstraint)
  public
...
function TIsdivisibleby.Validate(const Value: TValue;
