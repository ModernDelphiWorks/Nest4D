...
unit Nidus.Vlidation.IsVariableWidth;
...
type
  TIsvariablewidth = class(TValidatorConstraint)
  public
...
function TIsvariablewidth.Validate(const Value: TValue;
