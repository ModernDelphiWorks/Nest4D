...
unit Nidus.Validation.IsHexaDecimal;
...
type
  TIshexadecimal = class(TValidatorConstraint)
  public
...
function TIshexadecimal.Validate(const Value: TValue;
